...
<header class=" bg-indigo-900">
    <div class="container mx-auto flex flex-wrap items-center justify-between px-4 py-4">
        ...
        <div class="flex mx-auto max-sm:hidden max-lg:hidden" id="registro">
            <a href="login"
               class="inline-block mr-6 text-sm px-4 py-2 leading-none border rounded text-black border-yellow-400 bg-yellow-400 hover:border-transparent hover:text-gray-900 hover:bg-gray-100 mt-4 lg:mt-0"
               id="iniciar-sesion">
                Iniciar sesión
            </a>
            <a href="registrar-usuario"
               class="inline-block text-sm px-4 py-2 leading-none border rounded text-white  hover:border-transparent hover:text-gray-900 hover:bg-white mt-4 lg:mt-0"
               id="registrar">
                Registrate
            </a>
        </div>
            ...
            <div class="eventos m-2">
                ...
                <a href="#"
                   class="block max-w-sm p-6 bg-white border border-gray-200 rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <p class="font-normal text-gray-700 dark:text-gray-400">Sus selecciones seran añadidas</p>
                </a>
    ...
    fetch(`https://api.the-odds-api.com/v4/sports/${sport}/odds/?apiKey=${apiKey}&regions=${region}&market=h2h`)
        ...
        .then(data => {
            ...
            for (evento of data) {
                ...
                partido.innerHTML = `
                    <div class="text-center align-middle w-1/3">
                    <p class="font-semibold text-start w-max">${evento["home_team"]} VS ${evento["away_team"]}</p>

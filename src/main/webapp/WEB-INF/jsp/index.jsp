...
<header class="bg-[#1C1919] bg-opacity-80 mb-8">
    <div class="container mx-auto flex items-center justify-between p-4">
        ...
        <div  id="registro">
            <a href="login"
               class="inline-block font-semibold mr-6 text-sm px-4 py-2 leading-none rounded text-black  bg-red-400 hover:border-transparent hover:text-gray-900 hover:bg-gray-100 mt-4 lg:mt-0 "
               id="iniciar-sesion">
                Iniciar sesión
            </a>
            <a href="registro"

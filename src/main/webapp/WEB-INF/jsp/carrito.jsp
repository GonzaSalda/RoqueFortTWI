...
<div>
    ...
    <c:if test="${not empty lista_pizzas_carrito}">
        <div class="flex gap-2 my-2 flex-wrap">
            <c:forEach var="pizza" items="${lista_pizzas_carrito}">
                <div class="rounded-xl bg-[#1C1919] bg-opacity-80 w-[320px] h-[350px] p-4 mx-auto flex flex-col  h-full items-center justify-center">
                    ...
                    <div class="flex flex-col my-2 gap-2 text-white text-[15px] font-semibold items-center justify-center">
                        <div>
                            <p class="text-red-400 font-bold tracking-[0.10em]">${pizza.nombre}</p>
                        </div>
        ...
        <div class="rounded-xl bg-[#1C1919] bg-opacity-80 w-[520px] h-full p-4 mx-auto my-4">
            ...
            <div class="text-white font-bold w-full h-full flex flex-col gap-y-4 justify-center items-center">
